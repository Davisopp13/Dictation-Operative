...
4. Set your hotkeys in Settings → General (defaults: ⌘⇧D toggle; push-to-talk unset).

### Smoke-test checklist

- [ ] Toggle mode: press hotkey, speak, press again → text appears at the cursor
- [ ] Push-to-talk: hold, speak, release (a quick tap acts as a toggle)
